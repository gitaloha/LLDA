...
(function() {
    ...
    var Z = {
        ...
        _jump : function(AV, AU, B, AD, AC) {
            ...
            var q = "?click=1&url=" + W + "&uid=" + AT.bdUid + "&to=" + AW + "&type=text&relateUid=" + AL + "&pic=" + AB + "&title=" + U + "&key=" + (AT.snsKey[AV] || "") + "&sign=" + AT.review + "&desc=" + AK + "&comment=" + u + "&searchPic=" + AT.searchPic + "&l=" + AN + "&linkid=" + H + "&sloc=" + j + "&apiType=0&buttonType=" + D + "&firstime=" + J.getCookie("bdshare_firstime");
            if (AV == "mshare") {
